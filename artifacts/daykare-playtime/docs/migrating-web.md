# Migrating web UI to DayKare Playtime Design System

Read `artifacts/daykare-playtime/docs/AGENTS.md` and
`artifacts/daykare-playtime/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/daykare-playtime/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/daykare-playtime/lib/utils`
- `@/hooks/use-toast` → `@workspace/daykare-playtime/hooks/use-toast`
