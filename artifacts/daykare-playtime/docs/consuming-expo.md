# Consuming DayKare Playtime Design System in Expo apps

Read `artifacts/daykare-playtime/docs/AGENTS.md` first. React Native does
...
`artifacts/daykare-playtime/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/daykare-playtime/tokens";
...
```tsx
import { nativeTheme } from "@workspace/daykare-playtime/lib/native-theme";
import { useColors } from "@workspace/daykare-playtime/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/daykare-playtime/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/daykare-playtime/components/native/badge";
import { Button } from "@workspace/daykare-playtime/components/native/button";
import { Card } from "@workspace/daykare-playtime/components/native/card";
```
...
Import and render
`@workspace/daykare-playtime/components/native/button`, then run Expo
