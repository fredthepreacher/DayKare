...
export function DesignSystemBrowser() {
  ...
  const [darkMode, setDarkMode] = useState(() => {
    ...
    return requestedTheme === 'dark' || document.documentElement.classList.contains('dark');
  });
        ...
        <div className="border-b px-5 py-5">
          <div className="flex items-center gap-3">
            <img
              ...
              alt=""
              className="size-12 rounded-2xl border bg-card object-contain p-1 shadow-sm"
            />
            <div className="min-w-0 flex-1">
              <p className="font-serif text-base font-black leading-tight">{DESIGN_SYSTEM.title}</p>
            ...
            <button
              ...
              className="grid size-10 shrink-0 place-items-center rounded-xl border bg-card text-foreground shadow-sm transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring"
            >
        ...
        <div className="mx-auto max-w-5xl">
          <header className="border-b pb-8">
            {active.id === OVERVIEW_ENTRY.id ? (
              <>
                <p className="daykare-pattern-eyebrow">Extracted from the DayKare game</p>
