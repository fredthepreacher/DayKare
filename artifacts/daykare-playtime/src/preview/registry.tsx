...
const DayKarePatternsPage = lazyPage(() =>
  import('./patterns').then(({ DayKarePatternsPage }) => DayKarePatternsPage),
);
const ContentGuidelinesPage = lazyPage(() =>
  import('./patterns').then(({ ContentGuidelinesPage }) => ContentGuidelinesPage),
);
const MotionGuidelinesPage = lazyPage(() =>
  import('./patterns').then(({ MotionGuidelinesPage }) => MotionGuidelinesPage),
);
...
export const DESIGN_SYSTEM = {
  title: 'DayKare Playtime Design System',
  description:
    'Warm paper surfaces, storybook type, sunny activity colors, and accessible tactile controls for DayKare experiences.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'The visual foundations and principles that shape DayKare.',
  Page: OverviewPage,
};
...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    entries: [
      {
        id: 'brand-playtime-mark',
        name: 'Playtime mark',
        description: 'The retained DayKare app mark and its usage guidance.',
        Page: BrandPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        name: 'Voice and tone',
        description: 'Warm, direct, truthful language for children and families.',
    ...
    entries: [
      {
        ...
        description: 'Responsive movement with a complete reduced-motion path.',
  ...
  },
  {
    ...
    entries: [
      {
        id: 'applied-daykare-patterns',
        name: 'DayKare patterns',
        description: 'Destination actions, seat cards, status labels, and choice rows.',
        Page: DayKarePatternsPage,
      },
    ],
  },
];
