...
import { ANIMATION_CLIPS, CAPER_HEIST_RB, DEFAULT_AVATAR, FIRST_HEIST_RB, FULL_REDESIGN_PRICE, HEIST_STEPS, REPLAY_HEIST_RB, STARTER_HOME_PRICE, STORY_REWARDS, TUTORIAL_CHAPTERS, type AvatarProfile } from './finalMaster';
...
function HeistJobList() {
  ...
  return <div className="final-board-jobs">
    ...
    <article className="is-primary">
      ...
      <b>{STORY_REWARDS.leslieHeist.toLocaleString()} RB first clear · {REPLAY_HEIST_RB.toLocaleString()} RB per replay</b>
    </article>
