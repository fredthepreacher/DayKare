...
const HUB_STATIONS: Record<string, Station[]> = {
  ...
  // Art time used to line every child up along x = -12.4, two of them half a
  // metre apart - close enough to overlap, and reading as a queue rather
  // than a room of children. They now sit in small groups around the art
  // table and easel, no pair closer than 1.1 m.
  'art-time': [
    { activity: 'coloring', mode: 'coloring', position: [-12.5, 0, -10.6], focus: [-11.4, 0, -11.2], duration: 6.2 },
    { activity: 'drawing', mode: 'coloring', position: [-12.6, 0, -11.9], focus: [-11.4, 0, -12], duration: 6.4 },
    { activity: 'drawing', mode: 'coloring', position: [-12.6, 0, -13.2], focus: [-11.6, 0, -13], duration: 6.1 },
    { activity: 'picture-books', mode: 'reading', position: [-14.5, 0, -10.4], focus: [-13.4, 0, -10.8], duration: 5.8 },
    { activity: 'conversation', mode: 'conversation', position: [-14.6, 0, -11.8], focus: [-13.6, 0, -11.4], duration: 5.3 },
    { activity: 'parallel-play', mode: 'playing', position: [-14.6, 0, -15], focus: [-13.8, 0, -14.6], duration: 5.7 },
    { activity: 'pretend-play', mode: 'pretend-play', position: [-13.2, 0, -15], focus: [-12.6, 0, -14.2], duration: 5.5 },
    { activity: 'picture-books', mode: 'reading', position: [-11.7, 0, -15], focus: [-11, 0, -14.2], duration: 5.9 },
    { activity: 'parallel-play', mode: 'playing', position: [-10.2, 0, -14.9], focus: [-10, 0, -14], duration: 5.6 },
    { activity: 'singing', mode: 'singing', position: [-8.9, 0, -14.4], focus: [-9.4, 0, -13.6], duration: 5.2 },
    { activity: 'conversation', mode: 'conversation', position: [-12.7, 0, -9.2], focus: [-11.6, 0, -9.8], duration: 5.3 },
  ],
  ...
  'juice-club': [
    ...
    { activity: 'following', mode: 'following', position: [0.4, 0, 3.5], focus: [0.7, 0, 2.4], duration: 4 },
